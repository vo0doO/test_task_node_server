        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "result",
            "description": "<p>массив записей JSON о платежных транзакциях</p>"
          }
        ]
      }
    },
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "dateFrom",
            "description": "<p>дата являющаяся началом диапазона дат по которому необходимо отфильтровать записи о платёжных транзакциях</p>"
          },
          {
            "group": "Parameter",
            "type": "Date",
            "optional": false,
            "field": "dateTo",
            "description": "<p>дата являющаяся окончанием диапазона дат по которому необходимо отфильтровать записи о платёжных транзакциях</p>"
          }
        ]
      }
    },
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "result",
            "description": "<p>массив отфильтрованных записей JSON о платёжных транзакциях</p>"
          }
        ]
      }
    },
