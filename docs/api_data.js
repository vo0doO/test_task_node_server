        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "dateFrom",
            "description": "<p>дата началом диапазона по которому отфильтруются платёжные транзакции</p>"
          },
          {
            "group": "Parameter",
            "type": "Date",
            "optional": false,
            "field": "dateTo",
            "description": "<p>дата оконца диапазона дат по которому отфильтруются записи о платёжных транзакциях</p>"
          }
        ]
      }
    },
